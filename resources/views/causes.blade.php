...
<!-- Mirrored from perconcept.muzahid.com/Charity-sympathy/causes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Mar 2018 14:27:25 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <nav class="main-menu">
                    ...
                    <div class="navbar-collapse collapse clearfix">
                        <ul class="navigation clearfix">
                            ...
                            <li class="dropdown active"><a href="causes.html">Causes</a>
                                <ul>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="item">
						<div class="clearfix bg-area">
							<div class="image-box">
								<img src="images/causes/4.jpg" alt="Awesome Image"/>
								<div class="overlay">
									<div class="box">
										<div class="content">
											<a href="single-cause.html"><i class="fa fa-link"></i></a>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="item">
						<div class="clearfix bg-area">
							<div class="image-box">
								<img src="images/causes/5.jpg" alt="Awesome Image"/>
								<div class="overlay">
									<div class="box">
										<div class="content">
											<a href="single-cause.html"><i class="fa fa-link"></i></a>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="item">
						<div class="clearfix bg-area">
							<div class="image-box">
								<img src="images/causes/6.jpg" alt="Awesome Image"/>
								<div class="overlay">
									<div class="box">
										<div class="content">
											<a href="single-cause.html"><i class="fa fa-link"></i></a>
...
<!-- Mirrored from perconcept.muzahid.com/Charity-sympathy/causes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Mar 2018 14:27:30 GMT -->
</html>