...
<!-- Mirrored from perconcept.muzahid.com/Charity-sympathy/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Mar 2018 14:27:32 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <nav class="main-menu">
                    ...
                    <div class="navbar-collapse collapse clearfix">
                       <ul class="navigation clearfix">
                            ...
                            <li class="dropdown active"><a href="event.html">Events</a>
                                <ul>
	...
	<div class="container">
		...
		<div class="item-list">
			<div class="item wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
				<div class="bg-area">
					<div class="image-box">
						<img src="images/event/5.jpg" alt="Awesome Image"/>
						<div class="overlay">
							<div class="box">
								<div class="content">
			...
			<div class="item wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
				<div class="bg-area">
					<div class="image-box">
						<img src="images/event/6.jpg" alt="Awesome Image"/>
						<div class="overlay">
							<div class="box">
								<div class="content">
									<a href="event-details.html"><i class="fa fa-link"></i></a>
			...
			<div class="item wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
				<div class="bg-area">
					<div class="image-box">
						<img src="images/event/7.jpg" alt="Awesome Image"/>
						<div class="overlay">
							<div class="box">
								<div class="content">
									<a href="event-details.html"><i class="fa fa-link"></i></a>
...
<!-- Mirrored from perconcept.muzahid.com/Charity-sympathy/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Mar 2018 14:27:41 GMT -->
</html>